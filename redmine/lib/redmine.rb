...
Redmine::MenuManager.map :top_menu do |menu|
  menu.push :home, :home_path, :html => { :picto => true }
  menu.push :my_page, { :controller => 'my', :action => 'page' }, :if => Proc.new { User.current.logged? }, :html => { :picto => true }
  menu.push :projects, { :controller => 'projects', :action => 'index' }, :caption => :label_project_plural, :html => { :picto => true }
  menu.push :administration, { :controller => 'admin', :action => 'index' }, :if => Proc.new { User.current.admin? }, :html => { :picto => true }
  menu.push :help, Redmine::Info.help_url, :last => true, :html => { :picto => true }
end
...
Redmine::MenuManager.map :admin_menu do |menu|
  menu.push :projects, {:controller => 'admin', :action => 'projects'}, :caption => :label_project_plural, :html => { :picto => true }
  menu.push :users, {:controller => 'users'}, :caption => :label_user_plural, :html => { :picto => true }
  menu.push :groups, {:controller => 'groups'}, :caption => :label_group_plural, :html => { :picto => true }
  menu.push :roles, {:controller => 'roles'}, :caption => :label_role_and_permissions, :html => { :picto => true }
  menu.push :trackers, {:controller => 'trackers'}, :caption => :label_tracker_plural, :html => { :picto => true }
  menu.push :issue_statuses, {:controller => 'issue_statuses'}, :caption => :label_issue_status_plural,
            :html => {:class => 'issue_statuses'}, :html => { :picto => true }
  menu.push :workflows, {:controller => 'workflows', :action => 'edit'}, :caption => :label_workflow, :html => { :picto => true }
  menu.push :custom_fields, {:controller => 'custom_fields'},  :caption => :label_custom_field_plural,
            :html => {:class => 'custom_fields'}, :html => { :picto => true }
  menu.push :enumerations, {:controller => 'enumerations'}, :html => { :picto => true }
  menu.push :settings, {:controller => 'settings'}, :html => { :picto => true }
  menu.push :ldap_authentication, {:controller => 'auth_sources', :action => 'index'},
            :html => {:class => 'server_authentication'}, :html => { :picto => true }
  menu.push :plugins, {:controller => 'admin', :action => 'plugins'}, :last => true, :html => { :picto => true }
  menu.push :info, {:controller => 'admin', :action => 'info'}, :caption => :label_information_plural, :last => true, :html => { :picto => true }
end
